            ...
            @forelse ($this->report['rows'] as $row)
                <x-filament::section>
                    ...
                    <dl class="mt-4 grid grid-cols-2 overflow-hidden rounded-lg border border-gray-200 text-sm dark:border-gray-700">
                        ...
                        <div class="border-r border-gray-200 p-3 dark:border-gray-700"><dt class="text-xs text-gray-500">Sell-through</dt><dd class="mt-1 font-medium">{{ number_format($row['sell_through'], 1) }}%</dd></div>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                <table class="w-full min-w-[1450px] border-separate border-spacing-0 text-left text-sm">
                    ...
                    <thead class="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-800">
                        <tr>
                            <th scope="col" class="min-w-64 border-b border-r border-gray-200 px-4 py-4 dark:border-gray-700">Menu item</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Produced</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Wasted</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Net</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Units sold</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Amount sold</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Opening balance</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Period variance</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Closing balance</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Sell-through</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Revenue</th><th scope="col" class="border-b border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Closing stock</th>
                        </tr>
                    </thead>
