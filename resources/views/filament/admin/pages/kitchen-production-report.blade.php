        ...
        <x-filament::section class="hidden md:block">
            <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                <table class="w-full min-w-[1150px] border-separate border-spacing-0 text-left text-sm">
                    <caption class="sr-only">Kitchen production and stock report</caption>
                    <thead class="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-800">
                        <tr>
                            <th scope="col" class="min-w-64 border-b border-r border-gray-200 px-4 py-4 dark:border-gray-700">Menu item</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Produced</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Wasted</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Net</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Units sold</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Amount sold</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Remaining</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Sell-through</th><th scope="col" class="border-b border-r border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Revenue</th><th scope="col" class="border-b border-gray-200 px-4 py-4 whitespace-nowrap dark:border-gray-700">Status</th>
                        </tr>
                    </thead>
