<x-guest-layout>
    @php($billingPreview = session('conference_billing_preview'))
        ...
        <div class="mx-auto grid w-full max-w-5xl gap-6 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-start">
            <div>
                ...
                <form method="POST" action="{{ route('conference.booking.store') }}" class="rounded-2xl bg-white p-5 shadow-xl shadow-slate-200/70 ring-1 ring-slate-900/5 sm:p-8">
                    ...
                    <button type="submit" class="mt-7 flex min-h-12 w-full items-center justify-center rounded-xl bg-blue-600 px-4 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-blue-700">Continue to payment</button>
                </form>
            </div>
