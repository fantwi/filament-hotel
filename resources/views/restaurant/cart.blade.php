    ...
    <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        @else
            ...
            <div class="mt-8 ml-auto max-w-md rounded-2xl bg-white p-6 shadow-xl shadow-slate-200/70 ring-1 ring-slate-900/5">
                ...
                <p class="my-3 text-center text-sm font-medium text-slate-500">or</p>
                <a href="{{ route('restaurant.menu') }}" class="flex min-h-12 items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-3 text-center font-semibold text-slate-700 transition hover:bg-slate-50">Add more food items</a>
            </div>
        @endif
    </div>
</x-guest-layout>
