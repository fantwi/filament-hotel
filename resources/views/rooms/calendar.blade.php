<x-guest-layout>
    <section class="bg-slate-50 px-4 py-8 transition-colors dark:bg-[#161b48] sm:px-6 sm:py-14 lg:px-8">
        <div class="mx-auto max-w-7xl">
            <div class="mb-7 max-w-2xl"><p class="text-sm font-semibold uppercase tracking-[0.2em] text-blue-600 dark:text-blue-300">Plan your stay</p><h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">{{ $roomType->name }} availability</h1><p class="mt-3 text-sm leading-6 text-gray-600 dark:text-slate-300 sm:text-base">Use the calendar to view available dates and begin a reservation.</p></div>
            ...
            <div class="overflow-x-auto rounded-2xl border border-gray-100 bg-white p-3 shadow-xl shadow-slate-200/70 dark:border-white/10 dark:bg-slate-900 dark:shadow-none sm:p-6"><p class="mb-3 text-xs text-slate-500 dark:text-slate-400 sm:hidden">Swipe horizontally to view the full calendar.</p><div id="availability-calendar" class="min-w-[640px]"></div></div>
        </div>
    </section>
