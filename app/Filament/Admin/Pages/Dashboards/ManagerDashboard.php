...
class ManagerDashboard extends Dashboard
{
    ...
    public function getWidgets(): array { return [KitchenProductionStats::class, ManagerStats::class, ManagerPeriodReport::class, ManagerOperationsChart::class, RestaurantOrderStatusChart::class, KitchenOrderQueue::class]; }
}
