...
class ManagerDashboard extends Dashboard
{
    ...
    {
        return [KitchenProductionStats::class, ManagerStats::class, ManagerPeriodReport::class, ManagerOperationsChart::class, RestaurantOrderStatusChart::class, KitchenOrderQueue::class];
    }
}
