...
class SuperAdminDashboard extends Dashboard
{
    ...
    public function getWidgets(): array { return [SuperAdminStats::class, RestaurantRevenueChart::class, RestaurantOrderStatusChart::class, BestSellingMenuItems::class, KitchenOrderQueue::class]; }
}
